                                ...
                                for(int i=0;i<43;i++)
                                        if(fabs(1.2*Rcutoff)<bin[i+1]&&Rcutoff!=0) {tempobin[i]=tempobin[i]+Livetime;
                                                ...
                                                for(int m=0;m<18;m++){
                                                        ...
                                                        if(Encinp<encinTOF[m]&&Rcutoff!=0) {esposizionep[m]=esposizionep[m]+Livetime;
                                                                esposizionepgeo[m][zonageo]=esposizionepgeo[m][zonageo]+Livetime;
                                                        }
							if(Encinp<encinNaF[m]&&Rcutoff!=0) {esposizionepNaF[m]=esposizionepNaF[m]+Livetime;
                                                                esposizionepgeoNaF[m][zonageo]=esposizionepgeoNaF[m][zonageo]+Livetime;
                                                        }
							if(Encinp<encinAgl[m]&&Rcutoff!=0) {esposizionepAgl[m]=esposizionepAgl[m]+Livetime;
                                                                esposizionepgeoAgl[m][zonageo]=esposizionepgeoAgl[m][zonageo]+Livetime;
                                                        }

                                                        if(Encind<encinTOF[m]&&Rcutoff!=0) {esposizioned[m]=esposizioned[m]+Livetime;
                                                                esposizionedgeo[m][zonageo]=esposizionedgeo[m][zonageo]+Livetime;
                                                        }
							if(Encind<encinNaF[m]&&Rcutoff!=0) {esposizionedNaF[m]=esposizionedNaF[m]+Livetime;
                                                                esposizionedgeoNaF[m][zonageo]=esposizionedgeoNaF[m][zonageo]+Livetime;
                                                        }
							if(Encind<encinAgl[m]&&Rcutoff!=0) {esposizionedAgl[m]=esposizionedAgl[m]+Livetime;

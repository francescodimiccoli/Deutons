		     ...
		     )	
{
	...
	gPad->SetGridx();
		...
		QUtofD_TOF->Scale(1/QUtofD_TOF->Integral());
		QUtof_TOF->Scale(1/QUtof_TOF->Integral());
		QUtofHe_TOF->Scale(1/QUtofHe_TOF->Integral());
		QUtofD_TOF->Draw();
		QUtof_TOF->Draw("same");
		...
		QUtofHe_NaF->SetLineColor(3);
                ...
                QUtofD_NaF->Scale(1/QUtofD_NaF->Integral());
                QUtof_NaF->Scale(1/QUtof_NaF->Integral());
		QUtofHe_NaF->Scale(1/QUtofHe_NaF->Integral());
		QUtofD_NaF->Draw();
		QUtof_NaF->Draw("same");
		...
		QUtofD_Agl->Scale(1/QUtofD_Agl->Integral());
                QUtof_Agl->Scale(1/QUtof_Agl->Integral());
                QUtofHe_Agl->Scale(1/QUtofHe_Agl->Integral());
		QUtofD_Agl->Draw();
		QUtof_Agl->Draw("same");
		...
		QLtofD_TOF->Scale(1/QLtofD_TOF->Integral());
		QLtof_TOF->Scale(1/QLtof_TOF->Integral());
		QLtofHe_TOF->Scale(1/QLtofHe_TOF->Integral());
		QLtofD_TOF->Draw();
		QLtof_TOF->Draw("same");
		...
		QLtofHe_NaF->SetLineColor(3);
                ...
                QLtofD_NaF->Scale(1/QLtofD_NaF->Integral());
                QLtof_NaF->Scale(1/QLtof_NaF->Integral());
		QLtofHe_NaF->Scale(1/QUtofHe_NaF->Integral());
		QLtofD_NaF->Draw();
		QLtof_NaF->Draw("same");
		...
		QLtofD_Agl->Scale(1/QLtofD_Agl->Integral());
                QLtof_Agl->Scale(1/QLtof_Agl->Integral());
                QLtofHe_Agl->Scale(1/QLtofHe_Agl->Integral());
		QLtofD_Agl->Draw();
		QLtof_Agl->Draw("same");
		...
		QTrackD_TOF->Scale(1/QTrackD_TOF->Integral());
		QTrack_TOF->Scale(1/QTrack_TOF->Integral());
		QTrackHe_TOF->Scale(1/QTrackHe_TOF->Integral());
		QTrackD_TOF->Draw();
		...
		QTrackHe_NaF->SetLineColor(3);
                ...
                QTrackD_NaF->Scale(1/QTrackD_NaF->Integral());
                QTrack_NaF->Scale(1/QTrack_NaF->Integral());
		QTrackHe_NaF->Scale(1/QUtofHe_NaF->Integral());
		QTrackD_NaF->Draw();
		...
		QTrackD_Agl->Scale(1/QTrackD_Agl->Integral());
                QTrack_Agl->Scale(1/QTrack_Agl->Integral());
                QTrackHe_Agl->Scale(1/QTrackHe_Agl->Integral());
		QTrackD_Agl->Draw();

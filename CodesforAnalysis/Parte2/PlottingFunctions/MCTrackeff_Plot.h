...
void 	MCTrackeff_Plot(TH1* EffTriggerMCP_R_TH1F,
   ...
   for (int i=0; i<17; i++) EffTriggerMCP->SetPoint (i,ToFPB.EkPerMassBinCent (i),EffTriggerMCP_TH1F->GetBinContent (i+1) );
   ...
   EffTriggerMCP->GetYaxis()->SetTitleSize (0.045);
   {
      ...
      for (int h=0; h<6; h++) {
         ...
         for (int i=0; i<17; i++) EffTriggerMCD[h]->SetPoint (i,ToFPB.EkPerMassBinCent (i),EffTriggerMCD_TH2F->GetBinContent (i+1,h+1) );
   ...
   for (int i=0; i<17; i++) EffTrackerMCP->SetPoint (i,ToFPB.EkPerMassBinCent (i),EffTrackerMCP_TH1F->GetBinContent (i+1) );
   ...
   EffTrackerMCP->GetYaxis()->SetTitleSize (0.045);
   {
      ...
      for (int h=0; h<6; h++) {
         ...
         for (int i=0; i<17; i++) EffTrackerMCD[h]->SetPoint (i,ToFPB.EkPerMassBinCent (i),EffTrackerMCD_TH2F->GetBinContent (i+1,h+1) );
   ...
   for (int i=0; i<17; i++) EffTOF_MCP->SetPoint (i,ToFPB.EkPerMassBinCent (i),EffTOF_MCP_TH1F->GetBinContent (i+1) );
   TGraph * EffTOF_MCD[6];
   ...
   EffTOF_MCP->GetYaxis()->SetTitleSize (0.045);
   {
      ...
      for (int h=0; h<6; h++) {
         ...
         for (int i=0; i<17; i++) EffTOF_MCD[h]->SetPoint (i,ToFPB.EkPerMassBinCent (i),EffTOF_MCD_TH2F->GetBinContent (i+1,h+1) );

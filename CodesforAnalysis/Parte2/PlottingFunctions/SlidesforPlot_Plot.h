...
void SlidesforPlot (string filename)
{
	...
	TH1F * LikData         = (TH1F*) inputHistoFile->Get ("LikData");
	TH1F * LikMC           = (TH1F*) inputHistoFile->Get ("LikMC");
	TH1F * LikMC_rew       = (TH1F*) inputHistoFile->Get ("LikMC_rew");
	TH1F * DistData        = (TH1F*) inputHistoFile->Get ("DistData");
	TH1F * DistMC          = (TH1F*) inputHistoFile->Get ("DistMC");
	TH1F * DistMC_rew      = (TH1F*) inputHistoFile->Get ("DistMC_rew");
	TH1F * LikData_bin     = (TH1F*) inputHistoFile->Get ("LikData_bin");
	TH1F * LikMC_bin       = (TH1F*) inputHistoFile->Get ("LikMC_bin");
	TH1F * LikMC_bin_rew   = (TH1F*) inputHistoFile->Get ("LikMC_bin_rew");
	TH1F * DistData_bin    = (TH1F*) inputHistoFile->Get ("DistData_bin");
	...
	TCanvas *f=new TCanvas("Reweighting - Likelihood");
	TCanvas *g=new TCanvas("Reweighting - Distance");
	...
	BetaTOF_P -> Scale(1/BetaTOF_P->Integral() );  
	BetaTOF_D -> Scale(1/BetaTOF_D->Integral() );
	...
	BetaNaF_P -> Scale(1/BetaTOF_P->Integral() );  
	BetaNaF_D -> Scale(1/BetaTOF_D->Integral() );
	...
	BetaAgl_P -> Scale(1/BetaTOF_P->Integral() );  
	BetaAgl_D -> Scale(1/BetaTOF_D->Integral() );
	...
	gPad->SetGridx();
	gPad->SetGridy();
	LikData->SetLineColor(1);
	LikData->SetLineWidth(4); 
	LikMC->SetLineColor(2);
	LikMC->SetLineWidth(4); 
	LikMC_rew->SetLineColor(4);
	LikMC_rew->SetLineWidth(4);
	LikMC_rew->SetLineStyle(1);

	LikData->Scale(1/LikData->Integral());
	LikMC->Scale(1/LikMC->Integral());
	LikMC_rew->Scale(1/LikMC_rew->Integral());

        LikData->GetYaxis()->SetRangeUser(0,0.04);
	LikData->GetXaxis()->SetTitle("Likelihood Discriminant");
	LikData->GetXaxis()->SetTitleSize(0.045);
	LikData->SetTitle("Likelihood Distribution (0-100 GV range)");
	...
	{
		TLegend* leg =new TLegend (0.4, 0.7,0.95,0.95);
		leg->AddEntry (LikData,"ISS Data", "l");
		leg->AddEntry (LikMC,"Protons MC", "l");
		leg->AddEntry (LikMC_rew,"Reweighted Protons MC", "l");
	...
	gPad->SetGridx();
	gPad->SetGridy();
	LikData_bin->SetLineColor(1);
	LikData_bin->SetLineWidth(4); 
	LikMC_bin->SetLineColor(2);
	LikMC_bin->SetLineWidth(4); 
	LikMC_bin_rew->SetLineColor(4);
	LikMC_bin_rew->SetLineWidth(4);
	LikMC_bin_rew->SetLineStyle(1);

	LikData_bin->Scale(1/LikData_bin->Integral());
	LikMC_bin->Scale(1/LikMC_bin->Integral());
	LikMC_bin_rew->Scale(1/LikMC_bin_rew->Integral());

        LikData_bin->GetYaxis()->SetRangeUser(0,0.04);
	LikData_bin->GetXaxis()->SetTitle("Likelihood Discriminant");
	LikData_bin->GetXaxis()->SetTitleSize(0.045);
	LikData_bin->Draw();
	LikData_bin->SetTitle("Likelihood Distribution (1-2 GV range)");
	LikMC_bin->Draw("same");
	LikMC_bin_rew->Draw("same");
	{
		TLegend* leg =new TLegend (0.4, 0.7,0.95,0.95);
		leg->AddEntry (LikData_bin,"ISS Data", "l");
		leg->AddEntry (LikMC_bin,"Protons MC", "l");
		leg->AddEntry (LikMC_bin_rew,"Reweighted Protons MC", "l");
	...
	gPad->SetGridx();
	gPad->SetGridy();
	DistData->SetLineColor(1);
	DistData->SetLineWidth(4); 
	DistMC->SetLineColor(2);
	DistMC->SetLineWidth(4); 
	DistMC_rew->SetLineColor(4);
	DistMC_rew->SetLineWidth(4);
	DistMC_rew->SetLineStyle(1);

	DistData->Scale(1/DistData->Integral());
	DistMC->Scale(1/DistMC->Integral());
	DistMC_rew->Scale(1/DistMC_rew->Integral());
	DistData->GetXaxis()->SetTitle("Distance from P");
        DistData->GetXaxis()->SetTitleSize(0.045);
	DistData->SetTitle("Distance Distribution (0-100 GV range)");

	DistData->Draw();
	DistMC->Draw("same");
	DistMC_rew->Draw("same");

	{
		TLegend* leg =new TLegend (0.4, 0.7,0.95,0.95);
		leg->AddEntry (DistData,"ISS Data", "l");
		leg->AddEntry (DistMC,"Protons MC", "l");
		leg->AddEntry (DistMC_rew,"Reweighted Protons MC", "l");
	...
	gPad->SetGridx();
	gPad->SetGridy();
	DistData_bin->SetLineColor(1);
	DistData_bin->SetLineWidth(4); 
	DistMC_bin->SetLineColor(2);
	DistMC_bin->SetLineWidth(4); 
	DistMC_bin_rew->SetLineColor(4);
	DistMC_bin_rew->SetLineWidth(4);
	DistMC_bin_rew->SetLineStyle(1);

	DistData_bin->Scale(1/DistData_bin->Integral());
	DistMC_bin->Scale(1/DistMC_bin->Integral());
	DistMC_bin_rew->Scale(1/DistMC_bin_rew->Integral());
	DistData_bin->GetXaxis()->SetTitle("Distance from P");
        DistData_bin->GetXaxis()->SetTitleSize(0.045);
	DistData_bin->SetTitle("Distance Distribution (1-2 GV range)");

	DistData_bin->Draw();
	DistMC_bin->Draw("same");
	DistMC_bin_rew->Draw("same");

	{
		TLegend* leg =new TLegend (0.4, 0.7,0.95,0.95);
		leg->AddEntry (DistData_bin,"ISS Data", "l");
		leg->AddEntry (DistMC_bin,"Protons MC", "l");
		leg->AddEntry (DistMC_bin_rew,"Reweighted Protons MC", "l");

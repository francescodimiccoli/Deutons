...
void   MCQualeff_Plot(	
  ...
  string MCLegend[7]= {"Protons MC B800","Deuteorons MC \"GG_Blic\"","Deuterons MC \"GG_BlicDPMJet\"","Deuterons MC \"GG_QMD\"","Deuterons MC \"Shen_Blic\"","Deuterons MC \"Shen_BlicDPMJet\"","Deuterons MC \"Shen_QMD\""};
   ...
   TGraph *EffMCLikD[6];
   for(int i=0; i<nbinsr; i++) EffMCLikP->SetPoint(i,PRB.RigBinCent(i),EffMCLikP_TH1F->GetBinContent(i+1));
   ...
   TGraph *EffMCDistD[6];
   for(int i=0; i<nbinsr; i++) EffMCDistP->SetPoint(i,PRB.RigBinCent(i),EffMCDistP_TH1F->GetBinContent(i+1));

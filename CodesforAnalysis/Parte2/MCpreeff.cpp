...
void MCpreseff_Fill(TNtuple *ntupla, int l) {
   ...
   if(Massa_gen<1&&Massa_gen>0.5) {
      ...
      EffpreselMCP->beforeAgl->Fill( GetArrayBin(Var3, AglPB.MomBins()), GetMCGenWeight() );
      ...
      if(Unbias==0 && ((int)Cutmask&187)==187 && Beta_pre>0 && R_pre>0)
      {
         ...
         if(((int)Cutmask)>>11==0  ) EffpreselMCP->afterAgl->Fill(GetArrayBin(Var2, AglPB.MomBins()) , GetMCGenWeight() );
      }
   ...
   if(Massa_gen>1&&Massa_gen<2) {
      ...
      // Beta bins
         ...
         FillBinMGen(EffpreselMCD->beforeAgl, GetArrayBin(Var3, AglDB.MomBins()) );
         ...
         if(((int)Cutmask&187)==187 && Beta_pre>0 && Unbias==0 && R_pre>0)
         {
            ...
            if(((int)Cutmask)>>11 == 0   ) FillBinMGen(EffpreselMCD->afterAgl, GetArrayBin(Var2, AglDB.MomBins()));
         }

...
*/
   ...
   FitTOF_Pbins 	 ->  SetFitConstraints(0.8,1,0.00,0.02,0.00,0.0025);
   FitNaF_Pbins 	 ->  SetFitConstraints(0.8,1,0.00,0.02,0.00,0.0015);
   FitAgl_Pbins 	->  SetFitConstraints(0.8,1,0.00,0.02,0.00,0.0005);

...
TH2F *DTemplatesTOF_Dist  =new TH2F("DTemplatesTOF_Dist","DTemplatesTOF_Dist",          50,-1,1,nbinsToF,0,nbinsToF);
TH2F *PTemplatesTOF_Dist  =new TH2F("PTemplatesTOF_Dist","PTemplatesTOF_Dist",          50,-1,1,nbinsToF,0,nbinsToF);
TH2F *HeTemplatesTOF_Dist =new TH2F("HeTemplatesTOF_Dist","HeTemplatesTOF_Dist",        50,-1,1,nbinsToF,0,nbinsToF);

TH2F *DTemplatesNaF_Dist  =new TH2F("DTemplatesNaF_Dist","DTemplatesNaF_Dist",          50,-1,1,nbinsNaF,0,nbinsNaF);
TH2F *PTemplatesNaF_Dist  =new TH2F("PTemplatesNaF_Dist","PTemplatesNaF_Dist",          50,-1,1,nbinsNaF,0,nbinsNaF);
TH2F *HeTemplatesNaF_Dist =new TH2F("HeTemplatesNaF_Dist","HeTemplatesNaF_Dist",        50,-1,1,nbinsNaF,0,nbinsNaF);

TH2F *DTemplatesAgl_Dist  =new TH2F("DTemplatesAgl_Dist","DTemplatesAgl_Dist",          50,-1,1,nbinsAgl,0,nbinsAgl);
TH2F *PTemplatesAgl_Dist  =new TH2F("PTemplatesAgl_Dist","PTemplatesAgl_Dist",          50,-1,1,nbinsAgl,0,nbinsAgl);
TH2F *HeTemplatesAgl_Dist =new TH2F("HeTemplatesAgl_Dist","HeTemplatesAgl_Dist",        50,-1,1,nbinsAgl,0,nbinsAgl);

TH2F *DTemplatesTOF_Dist2 =new TH2F("DTemplatesTOF_Dist2","DTemplatesTOF_Dist2",        50,-1,1,nbinsToF,0,nbinsToF);
TH2F *PTemplatesTOF_Dist2 =new TH2F("PTemplatesTOF_Dist2","PTemplatesTOF_Dist2",        50,-1,1,nbinsToF,0,nbinsToF);
TH2F *HeTemplatesTOF_Dist2=new TH2F("HeTemplatesTOF_Dist2","HeTemplatesTOF_Dist2",      50,-1,1,nbinsToF,0,nbinsToF);

TH2F *DTemplatesNaF_Dist2 =new TH2F("DTemplatesNaF_Dist2","DTemplatesNaF_Dist2",        50,-1,1,nbinsNaF,0,nbinsNaF);
TH2F *PTemplatesNaF_Dist2 =new TH2F("PTemplatesNaF_Dist2","PTemplatesNaF_Dist2",        50,-1,1,nbinsNaF,0,nbinsNaF);
TH2F *HeTemplatesNaF_Dist2=new TH2F("HeTemplatesNaF_Dist2","HeTemplatesNaF_Dist2",      50,-1,1,nbinsNaF,0,nbinsNaF);

TH2F *DTemplatesAgl_Dist2 =new TH2F("DTemplatesAgl_Dist2","DTemplatesAgl_Dist2",        50,-1,1,nbinsAgl,0,nbinsAgl);
TH2F *PTemplatesAgl_Dist2 =new TH2F("PTemplatesAgl_Dist2","PTemplatesAgl_Dist2",        50,-1,1,nbinsAgl,0,nbinsAgl);
TH2F *HeTemplatesAgl_Dist2=new TH2F("HeTemplatesAgl_Dist2","HeTemplatesAgl_Dist2",      50,-1,1,nbinsAgl,0,nbinsAgl);

TH3F *DhistosgeoTOF_Dist  =new TH3F("DhistosgeoTOF_Dist","DhistosgeoTOF_Dist",11,0,11,  50,-1,1,nbinsToF,0,nbinsToF);
TH3F *DhistosgeoNaF_Dist  =new TH3F("DhistosgeoNaF_Dist","DhistosgeoNaF_Dist",11,0,11,  50,-1,1,nbinsNaF,0,nbinsNaF);
TH3F *DhistosgeoAgl_Dist  =new TH3F("DhistosgeoAgl_Dist","DhistosgeoAgl_Dist",11,0,11,  50,-1,1,nbinsAgl,0,nbinsAgl);

TH2F *DhistosTOF_Dist     =new TH2F("DhistosTOF_Dist","DhistosTOF_Dist",                50,-1,1,nbinsToF,0,nbinsToF);
TH2F *DhistosNaF_Dist     =new TH2F("DhistosNaF_Dist","DhistosNaF_Dist",                50,-1,1,nbinsNaF,0,nbinsNaF);
TH2F *DhistosAgl_Dist     =new TH2F("DhistosAgl_Dist","DhistosAgl_Dist",                50,-1,1,nbinsAgl,0,nbinsAgl);

TH2F *DhistosTOF_Dist2    =new TH2F("DhistosTOF_Dist2","DhistosTOF_Dist2",              50,-1,1,nbinsToF,0,nbinsToF);
TH2F *DhistosNaF_Dist2    =new TH2F("DhistosNaF_Dist2","DhistosNaF_Dist2",              50,-1,1,nbinsNaF,0,nbinsNaF);
TH2F *DhistosAgl_Dist2    =new TH2F("DhistosAgl_Dist2","DhistosAgl_Dist2",              50,-1,1,nbinsAgl,0,nbinsAgl);
   ...
   if(Likcut&&R<4&&Distcut) {
      if(Massa_gen<1&&Massa_gen>0.5)
         for(int m=0; m<nbinsToF; m++)  {
            if(Var>BetaD[m]&&Var<=BetaD[m+1]) PTemplatesTOF_Dist->Fill((Dist5D_P-Dist5D)/(Dist5D_P+Dist5D),m+0.1); ;
            if(Var>BetaP[m]&&Var<=BetaP[m+1]) PTemplatesTOF_Dist2->Fill((Dist5D_P-Dist5D)/(Dist5D_P+Dist5D),m+0.1);
         }
      if(Massa_gen<2&&Massa_gen>1.5)
         for(int m=0; m<nbinsToF; m++)  {
            if(Var>BetaD[m]&&Var<=BetaD[m+1]) DTemplatesTOF_Dist->Fill((Dist5D_P-Dist5D)/(Dist5D_P+Dist5D),m+0.1);
            if(Var>BetaP[m]&&Var<=BetaP[m+1]) DTemplatesTOF_Dist2->Fill((Dist5D_P-Dist5D)/(Dist5D_P+Dist5D),m+0.1);
         }
      if(Massa_gen<4&&Massa_gen>2.5)
         for(int m=0; m<nbinsToF; m++)  {
            if(Var>BetaD[m]&&Var<=BetaD[m+1]) HeTemplatesTOF_Dist->Fill((Dist5D_P-Dist5D)/(Dist5D_P+Dist5D),m+0.1);
   ...
   if(Likcut&&R<40&&Distcut) {
      ...
      if(Massa_gen<1&&Massa_gen>0.5)
         ...
         {  if((((int)Cutmask)>>11)==0&&Var2>BetaAglD[m]&&Var2<=BetaAglD[m+1]) {
               PTemplatesAgl_Dist->Fill((Dist5D_P-Dist5D)/(Dist5D_P+Dist5D),m+0.1);
            }
...
TCanvas *c40_ToF[12][nbinsToF];
TCanvas *c40_NaF[12][nbinsNaF];
TCanvas *c40_Agl[12][nbinsAgl];

TH3F * DCountsgeoTOF_Dist = new TH3F("DCountsgeoTOF_Dist", "DCountsgeoTOF_Dist", nbinsToF,0,nbinsToF,12,0,12,2,0,2);
TH3F * DCountsgeoNaF_Dist = new TH3F("DCountsgeoNaF_Dist", "DCountsgeoNaF_Dist", nbinsNaF,0,nbinsNaF,12,0,12,2,0,2);
TH3F * DCountsgeoAgl_Dist = new TH3F("DCountsgeoAgl_Dist", "DCountsgeoAgl_Dist", nbinsAgl,0,nbinsAgl,12,0,12,2,0,2);
TH2F * PCountsTOF_Dist    = new TH2F("PCountsTOF_Dist",    "PCountsTOF_Dist"   , nbinsToF,0,nbinsToF,2,0,2);
TH2F * PCountsNaF_Dist    = new TH2F("PCountsNaF_Dist",    "PCountsNaF_Dist"   , nbinsNaF,0,nbinsNaF,2,0,2);
TH2F * PCountsAgl_Dist    = new TH2F("PCountsAgl_Dist",    "PCountsAgl_Dist"   , nbinsAgl,0,nbinsAgl,2,0,2);
...
void DeutonsTemplFits_Dist(TFile * file1) {
   ...
   TH1F *DataDistTOF[12][nbinsToF];
   TH1F *DTemplTOF[nbinsToF];
   TH1F *PTemplTOF[nbinsToF];
   TH1F *HeTemplTOF[nbinsToF];
   TH1F *DTemplTOF2[nbinsToF];
   TH1F *PTemplTOF2[nbinsToF];
   TH1F *HeTemplTOF2[nbinsToF];
   ...
   TFractionFitter * fitT[nbinsToF][12]= {{NULL}};
   TObjArray *Tpl[nbinsToF][12]= {{NULL}};
   int cut1=21;
   int cut2=29;
   int s1[nbinsToF][12]= {{0}};
   float Err[nbinsToF][12]= {{0}};
   TH1F *PTemplTOFW[nbinsToF][12];
   TH1F *DTemplTOFW[nbinsToF][12];
   TH1F *HeTemplTOFW[nbinsToF][12];
   for(int i=0; i<12; i++) for(int m=0; m<nbinsToF; m++)c40_ToF[i][m]=new TCanvas();
   bool He=true;
   for(int i=0; i<12; i++) for(int m=0; m<nbinsToF; m++) {
         c40_ToF[i][m]->cd();
   ...
   TH1F *DataDistNaF[12][nbinsNaF];
   TH1F *DTemplNaF[nbinsNaF];
   TH1F *PTemplNaF[nbinsNaF];
   TH1F *HeTemplNaF[nbinsNaF];
   TH1F *DTemplNaF2[nbinsNaF];
   TH1F *PTemplNaF2[nbinsNaF];
   TH1F *HeTemplNaF2[nbinsNaF];
   for(int m=0; m<nbinsNaF; m++) {
   ...
   TFractionFitter * fitTNaF[nbinsNaF][12]= {{NULL}};
   TObjArray *TplNaF[nbinsNaF][12]= {{NULL}};
   int cutNaF=0;
   int s1NaF[nbinsNaF][12]= {{0}};
   float ErrNaF[nbinsNaF][12]= {{0}};
   TH1F *PTemplNaFW[nbinsNaF][12];
   TH1F *DTemplNaFW[nbinsNaF][12];
   TH1F *HeTemplNaFW[nbinsNaF][12];
   for(int i=0; i<12; i++) for(int m=0; m<nbinsNaF; m++) c40_NaF[i][m]=new TCanvas();
   He=true;
   for(int i=0; i<12; i++) for(int m=0; m<nbinsNaF; m++) {
         c40_NaF[i][m]->cd();
         cutNaF=0;
         He=false;
   ...
   TH1F *DataDistAgl[12][nbinsAgl];
   TH1F *DTemplAgl[nbinsAgl];
   TH1F *PTemplAgl[nbinsAgl];
   TH1F *HeTemplAgl[nbinsAgl];
   TH1F *DTemplAgl2[nbinsAgl];
   TH1F *PTemplAgl2[nbinsAgl];
   TH1F *HeTemplAgl2[nbinsAgl];
   for(int m=0; m<nbinsAgl; m++) {
   ...
   TFractionFitter * fitTAgl[nbinsAgl][12]= {{NULL}};
   TObjArray *TplAgl[nbinsAgl][12]= {{NULL}};
   int cutAgl=16;
   int s1Agl[nbinsAgl][12]= {{0}};
   float ErrAgl[nbinsAgl][12]= {{0}};
   TH1F *PTemplAglW[nbinsAgl][12];
   TH1F *DTemplAglW[nbinsAgl][12];
   TH1F *HeTemplAglW[nbinsAgl][12];
   for(int i=0; i<12; i++) for(int m=0; m<nbinsAgl; m++) c40_Agl[i][m]=new TCanvas();
   He=false;
   for(int i=0; i<12; i++) for(int m=0; m<nbinsAgl; m++) {
         c40_Agl[i][m]->cd();
         cutAgl=0;
   ...
   cout<<"**** TOF ********"<<endl;
   for(int i=0; i<12; i++) {
      for(int m=0; m<nbinsToF; m++) cout<<s1[m][i]<<" ";
      cout<<endl;
   }
   cout<<"**** NaF ********"<<endl;
   for(int i=0; i<12; i++) {
      for(int m=0; m<nbinsNaF; m++) cout<<s1NaF[m][i]<<" ";
      cout<<endl;
   }
   cout<<"**** Agl ********"<<endl;
   for(int i=0; i<12; i++) {
      for(int m=0; m<nbinsAgl; m++) cout<<s1Agl[m][i]<<" ";
      cout<<endl;
   }

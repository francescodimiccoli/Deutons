...
float BetabinsNaF[nbinsbeta]={0.4};
float BetacentNaF[nbinsbeta]={0};
float EkincentNaF[nbinsbeta]={0};
float BetabinsNaFR_P[nbinsbeta]={0};
float BetabinsNaFR_D[nbinsbeta]={0};
float BetabinsAgl[nbinsbeta]={0.4};
float BetabinsAglR_P[nbinsbeta]={0};
float BetabinsAglR_D[nbinsbeta]={0};
float BetaP[nbinsbeta]={0};
float BetaD[nbinsbeta]={0};
float BetaNaFP[nbinsbeta]={0};
float BetaNaFD[nbinsbeta]={0};
float BetaAglP[nbinsbeta]={0};
float BetaAglD[nbinsbeta]={0};
float Unbias=0;
float BetacentAgl[nbinsbeta]={0};
float EkincentAgl[nbinsbeta]={0};
...
float deltaencinTOF[nbinsbeta];
float deltaencinNaF[nbinsbeta];
float deltaencinAgl[nbinsbeta];
float Var=0;
float Var2=0;
float Var3=0;
int Norm[11]={0};

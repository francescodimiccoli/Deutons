...
bool LikelihoodCut (Variables * vars){ return true;}//(vars->Likelihood>0.6);}
bool RICHBDTCut (Variables * vars){ return Qualitycut(vars,-vars->BDTDiscr,999999,-0.24,-0.235);  }

...
int main(int argc, char * argv[])
{
	...
	FileSaver finalResults;
        ...
        TTree *treeMC = (TTree *)fileMC->Get("Q");
        TTree *treeDT = (TTree *)fileDT->Get("Q");
	TTree *RawDT = (TTree *)fileDT->Get("trig");
	...
	DFluxTOF-> Eval_ExposureTime(RawDT,finalHistos,Refill);
        DFluxNaF-> Eval_ExposureTime(RawDT,finalHistos,Refill);
        DFluxAgl-> Eval_ExposureTime(RawDT,finalHistos,Refill);
...
*/
	...
	HEPFlux -> Eval_ExposureTime(RawDT,finalHistos,Refill);
	PFluxTOF-> Eval_ExposureTime(RawDT,finalHistos,Refill);
        PFluxNaF-> Eval_ExposureTime(RawDT,finalHistos,Refill);
        PFluxAgl-> Eval_ExposureTime(RawDT,finalHistos,Refill);

...
*/
	 ...
	 NaFfits->SetHeliumContamination(HeContNaF);
        ...
        // Aglfits->DisableFit();
	 Aglfits->SetFitConstraints(0.9,1,0.001,0.1,0.0001,0.3);
    ...
    ExtractSimpleCountNr(finalHistos,finalResults,TreeDT,PRB,GetRigidity,"HEPCounts","IsPositive&IsPreselected&LikelihoodCut&DistanceCut&IsPrimary",false);

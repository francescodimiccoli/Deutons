...
python --version
export PATH=/cvmfs/sft.cern.ch/lcg/releases/CMake/3.11.1-773ff/x86_64-slc6-gcc49-opt/bin:$PATH
cmake --version

# ROOT
echo "Exporting ROOT vars"
export ROOTSYS=/cvmfs/ams.cern.ch/Offline/dbar/public/installed/root-6.14.04
...
if [ -z "$DBARWD" ]; then
  export DBARWD=/cvmfs/ams.cern.ch/Offline/dbar/public/release_v6/e2_vdev_190525/slc6_gcc6.14/
fi

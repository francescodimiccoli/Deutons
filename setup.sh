...
#source /storage/gpfs_ams/ams/Prod/MCProd/AMSsoft/linux_slc6_gcc64/root534/bin/thisroot.sh
#source /storage/gpfs_ams/ams/Prod/MCProd/AMSsoft/linux_slc6_gcc64/root_v5.34ams/bin/thisroot.sh
